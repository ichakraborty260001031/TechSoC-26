...
**My approach:**
- **Modular Data Processing:** Created a primary menu loop supporting dual input modes—manual interactive entry or batch file parsing.
...
- **File I/O Stuff** Before attempting this project, I had zero idea on how to do File Handling and this project gave me the chance to Explore File I/O.
